# serverless-caching-api-gateway



## Intro
A plugin for the serverless framework which helps with configuring caching for API Gateway endpoints. this is the work done on top of the existing serverless-api-gateway-caching npm module.
